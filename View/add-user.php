...
<body>
  <header>
    ...
    <!-- Jumbotron -->
    <div class="relative overflow-hidden bg-cover bg-no-repeat p-12 text-center" style="background-image: url('https://th.bing.com/th/id/R.7471f2178eb0331996be156483f15da5?rik=lF%2bl4gnp1Q20bQ&pid=ImgRaw&r=0'); height: 400px">
      <div class="absolute bottom-0 left-0 right-0 top-0 h-full w-full overflow-hidden bg-fixed" style="background-color: rgba(0, 0, 0, 0.6)">
        <div class="flex h-full items-center justify-center">
          <div class="text-white">
            <h2 class="mb-4 text-7xl font-semibold">Insira o seu <br> <b>Usuário</b></h2>
            <p>Para realizar os comentários dos personagens é necessário um novo usuário</p>
          </div>
        </div>
      </div>
    </div>
...
?>
    <form method="post" name="form1" action="" style="margin-top: 3rem;">
        <center><table width="50%"  border="5" bgcolor="lightgray" align ="center"></center>
            <tr align="center">
                <td width="118">
                    <font size="4" face="Times New Roman">Nome Completo:</font>
                </td>
                <td width="460">
                    <input name="nomeUser" type="text" class="formbutton" id="nomeUser" size="52" maxlength="150">
                </td>
            </tr>
            <tr align="center">
                <td>
                    <font size="4" face="Times New Roman">Sua Idade:</font>
                </td>
                <td>
                    <font size="4">
                        <input name="idadeUser" type="number" id="idadeUser" size="52" maxlength="150" class="formbutton">
                    </font>
                </td>
            </tr>
            <tr align="center">
                <td>
                    <font size="4" face="Times New Roman">Seu E-mail:</font>
                </td>
                <td>
                    <font size="4">
                        <input name="emailUser" type="text" id="emailUser" size="52" class="formbutton">
                    </font>
                </td>
            </tr>
            <tr align="center">
